...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(220000000);
...
const char     CRYPTONOTE_NAME[]                             = "memedcoin";
...
const int      P2P_DEFAULT_PORT                              = 34060;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 34061;
...
const std::initializer_list<const char*> SEED_NODES = {
  //"grow1.memedcoin.fun:34060,
  //"grow2.memedcoin.fun:34060,
};
